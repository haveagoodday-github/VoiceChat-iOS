 ...
 */
static NSString * _Nonnull const AgoraRtmEndcallPrefix = @"AgoraRTMLegacyEndcallCompatibleMessagePrefix";
...
8: The message receiver‘s SDK is of an earlier version and hence cannot recognize this message.
     */
    AgoraRtmSendPeerMessageErrorIncompatibleMessage = 8,
...
/**
Error codes related to attribute operations.
 */
...
102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method call of \ref agora::rtm::IRtmService::login "login" does not succeed before the metadata operation.
     */
    AgoraRtmMetadataOperationErrorUserNotLoggedIn = 102,
};
...
/**
 @brief Error codes related to subscribe/unsubscribe metadata.
    */
typedef NS_ENUM(NSInteger, AgoraRtmMetadataSubscriptionErrorCode) {
    /**
0: The method call succeeds, or the metadata subscription succeeds.
     */
    AgoraRtmMetadataSubscriptionErrorOk = 0,

    /**
1: Common failure. The metadata subscription fails.
     */
    AgoraRtmMetadataSubscriptionErrorFailure = 1,

    /**
2: A timeout occurs during the metadata subscription.
     */
    AgoraRtmMetadataSubscriptionErrorTimeout = 2,

    /**
3: The argument you put for this metadata subscription is invalid.
     */
    AgoraRtmMetadataSubscriptionErrorInvalidArgument = 3,

    /**
4: The method call frequency exceeds the limit.
     */
    AgoraRtmMetadataSubscriptionErrorTooOften = 4,

    /**
5: The number of users, to whom you subscribe, exceeds the limit.
     */
    AgoraRtmMetadataSubscriptionErrorOverflow = 5,

    /**
5: Unsubscribe user that was not be subscribed.
     */
    AgoraRtmMetadataSubscriptionErrorUserNotSubscribed = 6,

    /**
101: \ref agora::rtm::IRtmService "IRtmService" is not initialized.
     */
    AgoraRtmMetadataSubscriptionErrorNotInitialized = 101,
...
102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method call of \ref agora::rtm::IRtmService::login "login" does not succeed before the metadata subscription.
     */
    AgoraRtmMetadataSubscriptionErrorNotInitializedNotLoggedIn = 102,
};
...
/**
 @brief Structure of channel metadata and user metadata 
*/
__attribute__((visibility("default"))) @interface AgoraRtmMetadataItem: NSObject 

    /**
The key of the metadata item. The length of key must not exceed 32 bytes, and must not start with '_'.
     */
@property (nonatomic, copy, nonnull) NSString *key;

    /**
The value of the metadata item. The length of value must not exceed 16 KB.
     */
 ...
 **Note**
 - if revision was not set, means this operation will ignore this item's revision.
 - if revision was set, means this operation will check this item's revision, revision must be the same as the latest revision that acquired from metadataUpdated, getUserMetaWithCompletion, getChannelMetadataWithCompletion, where the item with same key. 
...
@property (nonatomic, assign) long long  revision;
    ...
    /**
The timestamp of when the metadata item was last updated.
     */
@property (nonatomic, assign, readonly) long long updateTs;

    /**
The User ID of the user who makes the latest update to the metadata item.
     */
@property (nonatomic, copy, nullable) NSString *authorUserId;

- (instancetype _Nonnull) init;
@end

/**
 @brief The option to modify metadata
*/
 ...
 **Note**
 - if majorRevision was not set, means this operation will ignore majorRevision.
 - if majorRevision was set, means this operation will check majorRevision, majorRevision must be the same as the latest majorRevision that acquired from metadataUpdated, getUserMetaWithCompletion, getChannelMetadataWithCompletion.
    */
...
Indicates whether or not to notify server update the modify timestamp of metadata
     */
@property (nonatomic, assign) BOOL enableRecordTs;

    /**
Indicates whether or not to notify server update the modify user id of metadata
     */
@property (nonatomic, assign) BOOL enableRecordUserId;

- (instancetype _Nonnull) init;
@end

/**
 @brief The structure of whole metadata acquired by metadataUpdated, getUserMetaWithCompletion, getChannelMetadataWithCompletion
*/
...
the revision of whole metadata.
     */
@property (nonatomic, assign, readonly) long long majorRevision;
@end
 ...
 */
typedef void (^AgoraRtmQueryPeersOnlineBlock)(NSArray<AgoraRtmPeerOnlineStatus *> * _Nullable peerOnlineStatus, AgoraRtmQueryPeersOnlineErrorCode errorCode);
 ...
 */
typedef void (^AgoraRtmRenewTokenBlock)(NSString * _Nonnull token, AgoraRtmRenewTokenErrorCode errorCode);
 ...
 */
typedef void (^AgoraRtmQueryPeersBySubscriptionOptionBlock)(NSArray<NSString *> * _Nonnull peers, AgoraRtmQueryPeersBySubscriptionOptionErrorCode errorCode);

/**
 Returns the result of addLocalUserMetadataWithCompletion, updateLocalUserMetadataWithCompletion, deleteLocalUserMetadataWithCompletion,setLocalUserMetadataWithCompletion,clearLocalUserMetadataWithCompletion
 and Channel metadata operations: updateChannelMetadataWithCompletion, deleteChannelMetadataWithCompletion, setChannelMetadataWithCompletion, clearChannelMetadataWithCompletion.
 
 @param errorCode see AgoraRtmMetadataOperationErrorCode.
*/
typedef void (^AgoraRtmMetadataModifyBlock)(AgoraRtmMetadataOperationErrorCode errorCode);

/**
 Returns the result of the getChannelMetadataWithCompletion method call.

 @param userId the UserId of metadata's owner.
 @param data the latest metadata.
 @param errorCode see AgoraRtmMetadataOperationErrorCode.

*/
typedef void (^AgoraRtmGetUserMetadataBlock)(NSString * _Nonnull userId, AgoraRtmMetadata* _Nullable data, AgoraRtmMetadataOperationErrorCode errorCode);

/**
 Returns the result of the subscribeUserMetadataWithWithCompletion or unsubscribeUserMetadataWithWithCompletion method call.

 @param errorCode see AgoraRtmMetadataSubscriptionErrorCode.

*/
typedef void (^AgoraRtmUserMetadataSubscriptionBlock)(NSString * _Nonnull userId, AgoraRtmMetadataSubscriptionErrorCode errorCode);
...
/**
 ...
 - If the SDK is in the `AgoraRtmConnectionStateConnected` state, the connection state switches to `AgoraRtmConnectionStateAborted` and you need to call the [loginByToken]([AgoraRtmKit loginByToken:user:completion:]) method to log in again.
 - If the SDK is in the `AgoraRtmConnectionStateReconnecting` state, you will receive this callback when the network reconnects and you need to call [renewToken]([AgoraRtmKit renewToken:completion:]) to pass the new token on to the server.
...
/**
 ...
 - Upon receiving this callback, generate a new token on the server and call the [renewToken]([AgoraRtmKit renewToken:completion:]) method to pass the new token to the SDK.
 - If the token used in a [loginByToken]([AgoraRtmKit loginByToken:user:completion:]) session expires, the user becomes offline and the SDK attempts to reconnect.
...
Occurs when user's metadata are updated
 ...
 @param kit An AgoraRtmKit instance.
 @param userId the UserId of occurred metadata's owner.
 @param data the latest metadata.
 */
- (void)rtmKit:(AgoraRtmKit * _Nonnull)kit userMetadataUpdated:(NSString * _Nonnull)userId metadata:(AgoraRtmMetadata * _Nonnull)data;
@end
 ...
 */
typedef void (^AgoraRtmGetUserAttributesBlock)(NSArray< AgoraRtmAttribute *> * _Nullable attributes, NSString * _Nonnull userId, AgoraRtmProcessAttributeErrorCode errorCode);
 ...
 */
typedef void (^AgoraRtmChannelMemberCountBlock)(NSArray<AgoraRtmChannelMemberCount *> * _Nullable channelMemberCounts, AgoraRtmChannelMemberCountErrorCode errorCode);
...
- User can only add items with keys that are different with items in latest metadata.

**NOTE**
- Add Operation will ignore revision check of each RtmMetadataItem.
- For addLocalUserMetadataWithCompletion, updateLocalUserMetadataWithCompletion, deleteLocalUserMetadataWithCompletion,setLocalUserMetadataWithCompletion,clearLocalUserMetadataWithCompletion and Channel metadata operations: updateChannelMetadataWithCompletion, deleteChannelMetadataWithCompletion, setChannelMetadataWithCompletion, clearChannelMetadataWithCompletion. taken together, the call frequency limit is 20 times every five seconds.
 
 @param items the items user wants to operate, each item must has unique key.
 @param options See AgoraRtmMetadataOptions.
 @param completionBlock return the result of this method call.
 */
...
/**
 Update the local user's metadata items.
  ...
  - User can only update items with keys that are same as items in latest metadata.
...
/**
 Delete the local user's metadata items.
  ...
  - items with keys that are same as items in latest metadata will be deleted, and items with keys that are different with items in latest metadata will be ignored.
...
/**
 ...
 - This operation will overwrite the whole metadata with items.
 ...
 **NOTE**
- For getUserMetadataWithCompletion and getChannelMetadataWithCompletion taken together, the call frequency limit is 20 times every five seconds.
 
 @param userId User IDs of the specified users.
 @param completionBlock return the result of this method call.
 */
...
/**
  ...
  **NOTE**
- For subscribeUserMetadataWithCompletion, the call frequency limit is 10 times every five seconds.
- User can only subscribe 50 users in total at same time.
...
/**
 ...
 - For subscribeUserMetadataWithCompletion, the call frequency limit is 10 times every five seconds.
- You can only subscribe 20 users at same time.
...
/**
 Returns the result of the [AgoraRtmChannel getChannelMetadata] method call.

  @param data the latest update of channel metadata.
  @param errorCode see AgoraRtmMetadataOperationErrorCode for the error codes.
*/
typedef void (^AgoraRtmGetChannelMetadataBlock)(AgoraRtmMetadata* data, AgoraRtmMetadataOperationErrorCode errorCode);
...
Occurs when channel's metadata are updated
 ...
 @param data The latest update of channel metadata.
*/
- (void)channel:(AgoraRtmChannel * _Nonnull)channel metadataUpdate:(AgoraRtmMetadata* _Nonnull)data;
